...
# --- 4. DATA PRESENTATION & CHARTS (STACKED LAYOUT) ---

# Section 4a: Main Bar Chart Visual
...
# Section 4b: Strategic Properties Table (Moved Below Chart)
